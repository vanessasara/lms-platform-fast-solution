...
export default async function CoursePage({ params }: CoursePageProps) {
  ...
  const isEnrolled = userId ? await isEnrolledInCourse(userId, course._id) : false;
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <span
                  ...
                  className="px-3 py-1 text-white rounded-full text-sm font-medium backdrop-blur-sm flex items-center gap-2"
                >
